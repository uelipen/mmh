      subroutine dlarnv(idist,iseed,n,vec)
      real vec(n), dlarnd

      do i=1,n
         vec(i)=dlarnd(idist,iseed)
      enddo
      return
      end

      subroutine slarnv(idist,iseed,n,vec)
      real*4 vec(n)
      real dlarnd
      ...
      real FUNCTION DLARND( IDIST, ISEED )
*
