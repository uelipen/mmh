c this file can be compiled with optimization.
c It calls routines from gfftnoopt.f, which are not allowed to be
c optimized
c
...
c
c part of code taken from Ed Bertschinger, see licence information below
c
      complex a(n/2+1,n,n)
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      real a(n1,n2,n3+2)
      call fft3rinv1(a,a,a,a,n1,n2,n3)
      return
      end
cccc

c the remainder of the file is taken from Ed Bertschinger's P3M package
c which comes with the following LICENCE file:


c************************************************************************
c./LICENSE            P3M License Information
c************************************************************************
c
c      This file is a REQUIRED part of the P3M package
c
cThis software is being provided to you, the LICENSEE, by the Massachusetts
cInstitute of Technology (M.I.T.) under the following license.  By
cobtaining, using and/or copying this software, you agree that you have
cread, understood, and will comply with these terms and conditions:
c
cPermission to use, copy, modify and distribute without fee or royalty at
cany tier, this software and its documentation, for any purpose and without
cfee or royalty is hereby granted, provided that you agree to comply with
cthe following copyright notice and statements, including the disclaimer,
cand that the same appear on ALL copies of the software and documentation,
cincluding modifications that you make for internal use or for distribution:
c
cCopyright 1995 by the Massachusetts Institute of Technology.  All rights
creserved.
c
cTHIS SOFTWARE IS PROVIDED "AS IS", AND M.I.T. MAKES NO REPRESENTATIONS OR
cWARRANTIES, EXPRESS OR IMPLIED.  By way of example, but not limitation,
cM.I.T. MAKES NO REPRESENTATIONS OR WARRANTIES OF MERCHANTABILITY OR FITNESS
cFOR ANY PARTICULAR PURPOSE OR THAT THE USE OF THE LICENSED SOFTWARE OR
cDOCUMENTATION WILL NOT INFRINGE ANY THIRD PARTY PATENTS, COPYRIGHTS,
cTRADEMARKS OR OTHER RIGHTS.
c
cThe name of the Massachusetts Institute of Technology or M.I.T. may NOT be
cused in advertising or publicity pertaining to distribution of the
csoftware.  Title to copyright in this software and any associated
cdocumentation shall at all times remain with M.I.T., and USER agrees to
cpreserve same.
c
cThis software was produced with funding support from the National
cScience Foundation under grant AST-9318185.
c
c
